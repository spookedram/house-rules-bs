var sampleChars = [
  ...
  },
  {
    ...
    "perk1desc": "If they roll higher than the target, the Cutpurse can steal a random item (decided on by the Game Master) from an NPC without them noticing.",
    "perk1mod": "dex",
    "perk2name": "Smoke Bombs",
    "perk2desc": "The Cutpurse throws down a small bomb that erupts into a cloud of smoke and dust, giving enemies -1 to PER and DEX DC rolls for 2 rounds.",
    "perk2mod": "dex",
    "perk3name": "Vanish",
    "perk3desc": "The Cutpurse vanishes from sight, remaining hidden for 3 rounds or until an enemy makes a successful PER DC check.",
    "perk3mod": "dex",
    "perk4name": "Poisoned Blade",
    "perk4desc": "The Cutpurse takes a turn to coat their blades in a deadly, fast-acting poison. Their next successful attack does 6d12 poison damage to their target.",
    "perk4mod": "int",
    "perk5name": "Keen Senses",
    "perk5desc": "The Cutpurse can temporarily focus their senses, which gives them +1 on PER DC checks for 5 rounds.",
    "perk5mod": "per",
    "perk6name": "Nimble Fingers",
    "perk6desc": "If they roll higher than the target, the Cutpurse can steal a specific item from an NPC without them noticing.",
    "perk6mod": "dex",
    "perk7name": "Skeleton Key",
    "perk7desc": "The Cutpurse can pick any physical lock without needing to make a DEX check.",
    "perk7mod": "dex",
    "perk8name": "Assassinate",
    "perk8desc": "If undetected, the Cutpurse can strike an enemy for 12d12 damage and remain undetected by other enemies in the area.",
    "perk8mod": "dex"
  },
  {
    "pin": 4,
  ...
  },
  {
    ...
    "perk4mod": "cha",
    "perk5name": "Song of Whispers",
    "perk5desc": "The bard plays a soft, fast, plucky tune that confuses enemies in a 40sqft radius. They temporarily lose 5 points to PER DC checks.",
    "perk5mod": "cha",
    ...
    "perk7desc": "The bard plays a love song that causes a target to take equal damage they inflict on themselves when they land a hit for 7 rounds.",
    "perk7mod": "cha",
  ...
  },
  {
    ...
    "perk1desc": "The Siren plays her harp, casting a spell to lure a target towards her. Target gets 1 movement, but it must be in the Siren's direction, and no action, for 1 round.",
    "perk1mod": "cha",
    "perk2name": "",
    "perk2desc": "",
    "perk2mod": "",
    ...
    "perk8desc": "The Siren sings her deadliest song. Any enemy within a 100sqft radius that fails a WIS DC check against the Siren's roll inflicts 12d12 damage to themselves, using their own weapons.",
    "perk8mod": "cha"
  }
];
