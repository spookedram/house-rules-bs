var sampleChars = [
  ...
  },
  {
    ...
    "wpn1desc": "A twisted cane made from burned black willow, used to summon dark creatures from a strange otherworld. The Swamp Witch can use it to summon a shadow minion (1d8 HP, 0 AC, 1d8 DMG) to fight for her. Commanding minions counts for the Swamp Witch's action.",
    "wpn1type": "Medium (d8)",
    "wpn2name": "Alligator",
  ...
  },
  {
    ...
    "perk4desc": "The Vampire can take the form of a small Vampire Bat for 4 rounds. He can fly and gains +4 to DEX, but can only do 1d4 damage in this form and cannot use his other perks until he shifts back.",
    "perk4mod": "wis",
    "perk5name": "Illusion",
  ...
  },
  {
    ...
    "wpn1desc": "A 3ft tall copper staff with small decorative wings at the top. Used for keeping sickly patients (and rowdy enemies) at a distance.",
    "wpn1type": "Medium (d8)",
    "wpn2name": "Healing Solution",
    "wpn2desc": "A packet of herbs, medicines, and chemicals that can heal an ally (d6 HP) on contact. Typically thrown from a distance.",
    "wpn2type": "Ranged (d6)",
    ...
    "perk7desc": "",
    "perk7mod": "",
    "perk8name": "Plague of Rats",
    "perk8desc": "The Plague Doctor opens his cloak and unleashes a swarm of plague rats to deal 6d12 damage to a target. If the attack hits and the target fails a VIT saving throw, they become diseased and take 1d12 damage for 6 rounds or until they make a successful VIT saving throw.",
    "perk8mod": "cha"
  },
  {
    "pin": 10,
    ...
    "perk8desc": "The Siren sings her deadliest song. Up to 12 enemies within a 100sqft radius that fail a WIS saving throw against the Siren's roll inflict an evenly distributed 12d12 damage to themselves, using their own weapons.",
    "perk8mod": "cha"
  }
];
