...
function addAnArea(mapId) {
  if(document.getElementById("area" + mapId + "Name").value !== "") {
    ...
    area.div = '<div id=' + area.pin + ' class="area panel panel-default"><div class="panel-heading"><h4 contenteditable="true">' + area.name + '</h4></div><div class="panel-body"><div class="row"><div class="col-sm-6"><button type="button" class="btn btn-default" onclick="addAreaDesc(this, ' + area.pin + ')" style="margin-bottom:15px; margin-right:15px; width:100%;">Add Description</button></div><div class="col-sm-6"><button type="button" class="btn btn-default" onclick="addEventInput(this, ' + area.pin + ', ' + map.pin + ')" style="margin-bottom:15px; width:100%;">Add an Event</button></div></div><h4>Events</h4><div id="area' + area.pin + 'eventList" class="row equal"></div></div><div class="panel-footer text-right no-print"><button type="button" class="btn btn-danger" onclick="setCurrentArea(' + area.pin + ',' + mapId + '), showModal(deleteAreaModal)">Delete Area</button></div></div>';
